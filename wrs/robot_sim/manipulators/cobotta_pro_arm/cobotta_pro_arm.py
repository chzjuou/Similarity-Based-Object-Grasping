...
class CobottaProArm(mi.ManipulatorInterface):

    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6), name='cobotta_pro', enable_cc=True):
        ...
        self.jlc.jnts[0]['loc_pos'] = np.array([0, 0, 0.099])
        self.jlc.jnts[1]['loc_pos'] = np.array([0, 0, 0.099])
        self.jlc.jnts[1]['motion_rng'] = [-4.72, 4.72]
        self.jlc.jnts[2]['loc_pos'] = np.array([0, -0.002, 0.109])
        self.jlc.jnts[2]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[2]['motion_rng'] = [-2.62, 2.62]
        self.jlc.jnts[3]['loc_pos'] = np.array([0, 0.002, 0.51])
        self.jlc.jnts[3]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[3]['motion_rng'] = [-2.62, 2.62]
        self.jlc.jnts[4]['loc_pos'] = np.array([-0.0, -0.03, 0.30])
        self.jlc.jnts[4]['loc_motionax'] = np.array([0, 0, 1])
        self.jlc.jnts[4]['motion_rng'] = [-4.72, 4.72]
        self.jlc.jnts[5]['loc_pos'] = np.array([0, 0.028, .088])
        self.jlc.jnts[5]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[5]['motion_rng'] = [-2.62, 2.62]
        self.jlc.jnts[6]['loc_pos'] = np.array([0, 0.12, 0.17])
        self.jlc.jnts[6]['loc_motionax'] = np.array([0, 0, 1])
        self.jlc.jnts[6]['motion_rng'] = [-6.29, 6.29]
        # links
...
if __name__ == '__main__':
    ...
    manipulator_instance = CobottaProArm(enable_cc=True)
    ...
    # gm.GeometricModel("./meshes/base_link.dae").attach_to(base)
    # gm.gen_frame().attach_to(base)
    base.run()